...
var DECREASE = "DECREASE"; // 액션 생성 함수 (type은 필수로 갖고 있어야함)

var toggelSwitch = function toggelSwitch() {
  {
    type: TOGGLE_SWITCH;
  }
};

var increase = function increase(diffrence) {
  {
...
var store = (0, _redux.createStore)(reducer); // 스토어 내장함수
